...
namespace Zeltex.Guis 
{
    ...
    public class CraftGui : MonoBehaviour
    {
        ...
        public void Awake() 
        {
            ...
            CraftedItemGui.OnSwapItems.AddListener(OnPickupCraftingItem);
        }
        ...
        public void OnSwapItems(Item ItemA, Item ItemB)
        {
            ...
            {
                Debug.LogError(ItemA.Name + " Is not in IngredientsInventory. Dont check recipes.");
                return;
            }
           ...
           // Debug.LogError("Checking recipes for Inventory: " + RecipesCount
            ...
            {
                MyRecipe = DataManager.Get().GetElement(DataFolderNames.Recipes, i) as Recipe;
                CraftedItem = MyRecipe.GetCraftedItem(IngredientsInventory);
        ...
        public void OnPickupCraftingItem(Item ItemA, Item ItemB, int QuantityPickedUp)
        {
            if (CraftingWithRecipe != null)
            {
                Debug.Log("Taking awake items from crafting inventory");
                CraftingWithRecipe.RemoveItems(CraftingBench, QuantityPickedUp);
            }
            else
            {
