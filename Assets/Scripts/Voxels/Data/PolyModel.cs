...
namespace Zeltex.Voxels
{
	...
	public class PolyModel : Element
    {
        ...
        public List<Vector2> GetTextureMapCoordinates(int TextureMapIndex, TileMap MyInfo)
        {
            ...
            {
                return TextureMaps[TextureMapIndex].GetCoordinates(MyInfo);
            }
            else
            {
        ...
        private List<Vector2> MyTextureCoordinates2 = new List<Vector2>();
        int i;
        int IndexBegin;
        int EndIndex;
        /// <summary>
        ...
        public List<Vector2> GetTextureMapCoordinates(int TextureMapIndex, int SideIndex, TileMap MyInfo)
        {
            if (TextureMapIndex >= 0 && TextureMapIndex < TextureMaps.Count)
            {
                ...
                EndIndex = IndexBegin + MyModels[5].Verticies.Count;
                if (SideIndex != 5)
                {
